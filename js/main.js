      ...
      const TRANSLATIONS = {
        pt: {
          ...
          "nav.contact": "Contato",
          "hero.title": "Olá, eu sou Silvio Yamada. <br />Eu transformo complexidade em experiências digitais que geram resultados.",
          ...
          "contact.paragraph": "Estou sempre aberto a novas oportunidades e projetos que exijam uma combinação de visão de design e profundidade técnica. Entre em contato!",
          "contact.linkedin": "LinkedIn",
          "contact.whatsapp": "WhatsApp",
          "footer.text": "📏 Desenvolvido por Silvio | UI/UX Designer © 2025",
          "portfolio.subtitle": "Uma seleção de trabalhos que demonstram meu processo, da pesquisa ao pixel final.",
          "cta.portfolio": "Veja Meu Portfólio",
          "cta.linkedin": "Conecte-se no LinkedIn",
          "about.paragraph": "Minha paixão está em todo o ciclo: da pesquisa e validação de necessidades de usuários à criação de interfaces atraentes e altamente utilizáveis.",
          ...
          "slide1.desc": "Projeto de reestruturação de UI/UX para editor de websites.",
          ...
          "slide2.desc": "Desenvolvimento de uma plataforma completa de agendamento online.",
          ...
          "slide7.desc": "Plataforma de gestão esportiva completa para times de basquetebol.",
          ...
          "slide8.desc": "Estratégia e design de conteúdo para fortalecer presença digital local.",
          "slide8.alt": "Peixinhos Restaurante — Mídias Sociais",
          "slide8.aria": "Abrir projeto Peixinhos no Behance",

          "exp.builderall.companyInfo": "A Builderall é uma plataforma de marketing digital completa que oferece diversas ferramentas em um único ambiente, com o objetivo de ajudar empreendedores e empresas a crescerem online.",
          "exp.builderall.description": "Responsável pelo design e usabilidade de uma suíte de 50+ ferramentas de marketing digital. Liderei o redesign de produtos-chave, resultando em melhorias na retenção e satisfação do usuário.",
          "exp.limodas.title": "Designer Gráfico",
          "exp.limodas.companyInfo": "A Li Modas Oficial é uma loja virtual especializada em vestidos temáticos infantis e juvenis, oferecendo produtos no atacado e varejo para todo o Brasil e exterior.",
          "exp.limodas.description": "Criação de identidade visual e materiais de marketing digital para e-commerce focado em moda infantil, impulsionando presença da marca nas redes sociais.",
          "exp.admake.companyInfo": "A Admake é uma agência especializada em e-commerce e marketing digital.",
          "exp.admake.description": "Desenvolvimento de layouts e front-end para websites institucionais e campanhas de marketing digital, garantindo desempenho visual e técnico.",
          "exp.horizon.title": "Gráfico & Web Designer",
          "exp.horizon.companyInfo": "A Horizon Marketing é uma empresa especializada em marketing para varejo.",
          "exp.horizon.description": "Focado na criação de identidades visuais e design de interfaces para websites e landing pages, garantindo consistência da marca no digital.",
          "exp.fisk.title": "Gráfico & Web Designer",
          "exp.fisk.companyInfo": "A FISK Marília é uma escola de idiomas que oferece cursos de inglês e espanhol.",
          "exp.fisk.description": "Produção de materiais gráficos promocionais, design de anúncios e atualização do website institucional para suportar campanhas de matrícula.",
          "exp.tray.companyInfo": "A Tray é uma plataforma de e-commerce robusta, pertencente à Locaweb, que facilita a criação e gestão de lojas virtuais.",
          "exp.tray.description": "Criação de layouts de e-commerce e banners promocionais para melhorar a atratividade visual e performance de vendas, otimizando a experiência do usuário.",
          "exp.rednose.title": "Web Designer / Fotografia",
          "exp.rednose.companyInfo": "A Red Nose é uma marca de moda masculina com estilo urbano, esportivo e casual.",
          "exp.rednose.description": "Responsável pelo design web e fotografia de produtos, criando identidade visual consistente e material fotográfico de alta qualidade para catálogos e campanhas.",

          "share.text": "💎 Achou meu trabalho interessante? Compartilhe com quem está procurando um designer de verdade!",
        ...
        en: {
          ...
          "nav.contact": "Contact",
          "hero.title": "Hi, I'm Silvio Yamada. <br />I turn complexity into digital experiences that deliver results.",
          "hero.subtitle": "With 17 years of experience, I focus on creating solutions that align user needs with business goals.",
          "section.what": "What I Bring to the Table",
          "portfolio.title": "Selected Portfolio",
          "portfolio.subtitle": "A curated selection of projects that show my process — from research to the final pixel.",
          "cta.portfolio": "See My Portfolio",
          "cta.linkedin": "Connect on LinkedIn",
          "about.paragraph": "My passion spans the full product lifecycle: from user research and needs validation to crafting attractive, highly usable interfaces.",
          ...
          "slide8.desc": "Content strategy and design to strengthen a local restaurant's digital presence.",
          "slide8.alt": "Peixinhos Restaurante — Social Media",
          "slide8.aria": "Open Peixinhos project on Behance",
          "exp.builderall.companyInfo": "Builderall is a comprehensive digital marketing platform that provides many tools in a single environment to help entrepreneurs and businesses grow online.",
          "exp.builderall.description": "Responsible for the design and usability of a suite of 50+ marketing tools. I led key product redesigns that significantly improved user retention and satisfaction.",
          "exp.limodas.title": "Graphic Designer",
          "exp.limodas.companyInfo": "Li Modas Oficial is an online store specialized in themed children's and youth dresses, offering wholesale and retail across Brazil and abroad.",
          "exp.limodas.description": "Created full visual identity and digital marketing assets for an e-commerce focused on children's fashion, boosting brand presence on social media.",
          "exp.admake.companyInfo": "Admake is an agency specialized in e-commerce and digital marketing.",
          "exp.admake.description": "Developed layouts and front-end for corporate websites and digital marketing campaigns, ensuring visual quality and technical performance.",
          "exp.horizon.title": "Graphic & Web Designer",
          "exp.horizon.companyInfo": "Horizon Marketing is a company specialized in retail marketing.",
          "exp.horizon.description": "Focused on brand visual identities and interface design for websites and landing pages, ensuring brand consistency across digital channels.",
          "exp.fisk.title": "Graphic & Web Designer",
          "exp.fisk.companyInfo": "FISK Marília is a language school offering English and Spanish courses.",
          "exp.fisk.description": "Produced promotional graphic materials (flyers, posters), ad designs and updated the institutional website to support enrollment campaigns.",
          "exp.tray.companyInfo": "Tray is a robust e-commerce platform by Locaweb that simplifies creating and managing online stores.",
          "exp.tray.description": "Created e-commerce layouts and promotional banners to improve visual appeal and sales performance, optimizing user experience on commerce platforms.",
          "exp.rednose.title": "Web Designer / Photography",
          "exp.rednose.companyInfo": "Red Nose is a men's fashion brand with an urban, sporty and casual style.",
          "exp.rednose.description": "Responsible for web design and product photography, creating consistent visual identity and high-quality photo material for catalogs and digital campaigns.",
          "contact.paragraph": "I’m open to new opportunities and projects that require both design vision and technical depth. Get in touch!",
          "share.text": "💎 Liked my work? Share it with someone looking for a real designer!",
